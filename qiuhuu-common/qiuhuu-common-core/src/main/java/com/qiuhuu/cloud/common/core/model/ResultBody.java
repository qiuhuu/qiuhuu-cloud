package com.qiuhuu.cloud.common.core.model;
...
public class ResultBody<T> implements Serializable {
    ...
    public ResultBody<T> success(int code){
        return success(code, "", null, HttpStatus.OK.value());
    }
    public ResultBody<T> success(int code, String message){
        return success(code, message, null, HttpStatus.OK.value());
    }
    public ResultBody<T> success(int code, String message, T data){
    ...
    public ResultBody<T> success(int code, String message, T data,int httpStatus){
        this.setCode(code);
    ...
    public ResultBody<T> success(ResultEnum resultEnum, T data,int httpStatus){
        return success(resultEnum.getCode(),resultEnum.getMessage(),data,httpStatus);
    }
    public ResultBody<T> success(ResultEnum resultEnum, T data){
        return success(resultEnum.getCode(),resultEnum.getMessage(),data);
    }
    public ResultBody<T> success(T data){
        return success(ResultEnum.OK,data);
    }

    public ResultBody<T> success(ResultEnum resultEnum){
        return success(resultEnum.getCode(),resultEnum.getMessage());
    }


    public ResultBody<T> failure(int code){
        return failure(code, "", null, HttpStatus.BAD_REQUEST.value());
    }
    public ResultBody<T> failure(int code, String message){
        return failure(code, message, null, HttpStatus.BAD_REQUEST.value());
    }
    public ResultBody<T> failure(int code, String message, T data){
     ...
     * @return ResultBody
     */
    public ResultBody<T> failure(int code, String message, T data,int httpStatus){
        this.setCode(code);
        this.setMessage(message);
        this.setData(data);
        this.setHttpStatus(httpStatus);
    ...
    public ResultBody<T> failure(ResultEnum resultEnum, T data,int httpStatus){
        return failure(resultEnum.getCode(),resultEnum.getMessage(),data,httpStatus);
    }
    public ResultBody<T> failure(ResultEnum resultEnum, T data){
        return failure(resultEnum.getCode(),resultEnum.getMessage(),data);
    }

    public ResultBody<T> failure(ResultEnum resultEnum){
